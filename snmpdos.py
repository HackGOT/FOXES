...
#SNMP Amp DOS attack
#by DaRkReD
#usage Hack-GOT.py <target ip> <snmpserver list> <number of threads> ex: Hack-GOT.py 1.2.3.4 file.txt 10
...
def printhelp():
	...
	print "By DaRkReD"
	print "Usage Hack-GOT.py <target ip> <snmpserver list> <number of threads>"
	print "ex: ex: Hack-GOT.py 1.2.3.4 file.txt 10"
